...
/*
 * test asserts type specialization
 */
function unionType(): string | number {
    return "foobar";
}

// here, foobar is detected as a string | number
const foobar = unionType();
httpAssert(typeof foobar === "string");
// thanks to the httpAssert, typescript should pick up that foobar can only be a string here.
